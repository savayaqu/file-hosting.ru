...
Route::middleware('auth:api')->group( function () {
    ...
    //Не знаю почему но именно путь /files/disk не работает, пишет что 404 not found
    ...
    //Не знаю почему но именно путь /files/shared не работает, пишет что 404 not found
